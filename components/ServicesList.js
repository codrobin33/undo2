    ...
    return (
        <div className="bg-white  overflow-hidden">
            <div className="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:gap-x-8 ">
                ...
                <div>
                    <h2 className="text-base font-semibold text-indigo-700 uppercase tracking-wide">Everything you need</h2>
                                ...
                                <dt>
                                    <Link href={feature.href} passHref>
                                        <a className="cursor-pointer  hover:underline">
                                            <LinkIcon className="absolute h-6 w-6 text-indigo-700" aria-hidden="true" />
